...
scoreTable = document.getElementById("scoreTable"), randomRGB, start, score = 0, count = 6, 
multiplier = 10, falseAnswers = 0, colors = [canvas1,canvas2,canvas3,canvas4,canvas5,canvas6];
